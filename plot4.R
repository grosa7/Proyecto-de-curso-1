...
# iniciar una trama compuesta con muchos gráficos
par(mfrow=c(2,2))

# llamando a la función gráfica básica que llama a diferentes funciones gráficas para construir las 4 gráficas que forman el gráfico
with(subpower,{
